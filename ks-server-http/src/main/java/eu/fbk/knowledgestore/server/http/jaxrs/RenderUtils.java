...
public final class RenderUtils {
            ...
            if (!isEmpty) {
                if (!isIterableOfSolutions) {
                    ...
                    Joiner.on("").appendTo(out,
                            render(null, (Iterable<BindingSet>) object).iterator());
                }
            }
     ...
     */
    public static Iterable<String> render(final List<String> variables,
    ...
    public static <T extends Appendable> T render(final String text, final String contentType,
            final T out) throws IOException {
    ...
    public static <T extends Appendable> T render(final String text, final List<Record> mentions,
            @Nullable final URI selection, final boolean canSelect, final boolean onlyMention,
            final UIConfig config, final T out) throws IOException {
