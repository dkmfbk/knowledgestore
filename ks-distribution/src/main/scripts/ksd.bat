...
"%JAVA%" %JAVA_OPTS% -classpath "%CLASSPATH%" -Dfile.encoding=UTF-8 -Dlauncher.executable="ksd" -Dlauncher.description="Runs the KnowledgeStore daemon, using the daemon and logging configurations optionally specified" -Dlauncher.config="ks.ttl" -Dlauncher.logging="ks.log.xml" eu.fbk.knowledgestore.runtime.Launcher %*
